...
- 2026-07-21: Multi-body arp slots H=2,H=3 (F4-S1). Extended `_ARP_HANDS` to `(0,1,2,3)`; voice bands `-22001..-22032` and `-23001..-23032`. No change to `advance_arp` (iterates hands). OSC wildcard `/digital/arp/*/*` already covers H=2,3. Contract polarity + golden updated. 107 tests passed.
